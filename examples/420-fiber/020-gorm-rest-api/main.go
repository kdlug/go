...
// curl -H "Content-Type:  application/json" -X POST  --data '{"title":"1984","author":"George Orwell","rating":5}' http://localhost:3000/api/v1/book
...
func setupRoutes(app *fiber.App) {
	app.Get("/", func(c *fiber.Ctx) error {
		return c.Status(http.StatusOK).SendString("Book Api Root")
	})
